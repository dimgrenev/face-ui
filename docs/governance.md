...
- The primary barrel is `/Users/grenev/Documents/uf/userface/face-ui-react/index.ts`.
- Deprecated aliases must not appear in the primary barrel, gallery, or component tree.
- Deprecated aliases may remain in `/Users/grenev/Documents/uf/userface/face-ui-react/compat.ts` only as an explicit migration path.
