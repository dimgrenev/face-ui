 ...
 */
import { forwardRef, useId, useCallback, useEffect } from 'react';
...
export const Modal = forwardRef(function Modal(props, ref) {
    ...
    useEffect(() => {
        if (controlledOpen === null || controlledOpen === isMachineOpen)
            return;
