...
const icons = {
    ...
    'cloud-done': (_jsx(_Fragment, { children: _jsx("g", { style: { mixBlendMode: "exclusion" }, children: _jsx("path", { d: "M8.5 9.5C8.5 7.29086 10 6 12 6C14 6 15 7.5 15 9M16 10C17.5 10 19 11.5 19 13.5C19 16 17.2091 17.25 15 17.25H12M7.5 10.5C6.5 10.5 5 11.567 5 13.5C5 15.433 6 17.25 8.5 17.25H10M9.18182 12.4176L11 14L14.1818 11", stroke: "white" }) }) })),
    ...
    'props': (_jsx(_Fragment, { children: _jsx("g", { style: { mixBlendMode: "exclusion" }, children: _jsx("path", { d: "M15 6C15 4.34315 13.6569 3 12 3C10.3431 3 9 4.34315 9 6C9 7.65685 10.3431 9 12 9C13.6569 9 15 7.65685 15 6ZM15 6L19 6M5 14C5 12.3431 6.34315 11 8 11C9.65685 11 11 12.3431 11 14C11 15.6569 9.65685 17 8 17C6.34315 17 5 15.6569 5 14ZM5 14L1 14M19 14L13 14M1 6L7 6", stroke: "white" }) }) })),
    ...
    'restart': (_jsx(_Fragment, { children: _jsx("g", { style: { mixBlendMode: "exclusion" }, children: _jsx("path", { d: "M9 17C7.5 17 5 15.5 5 12C5 10.223 5.7725 8.59864 7 7.5M15 7.5C16.5 7.5 19 9 19 12.5C19 14.277 18.2275 15.9014 17 17M12.25 16.5L10.75 15V18L12.25 16.5ZM11.75 7.5L13.25 9V6L11.75 7.5Z", stroke: "white" }) }) })),
